            ...
            <div class="banner-inner">
                ...
                <div class="auto-container">
                    ...
                    <div class="inner-container clearfix">
                        ...
                        <h1>{{$cancellationandrefunds->title}}</h1>
                        ...
                        <div class="page-nav">
                            ...
                            <ul class="bread-crumb clearfix">
                                ...
                                <li class="active">{{$cancellationandrefunds->title}}</li>
                        ...
                        <div class="text-col col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="inner">
                                ...
                                <div class="sec-title with-separator">
                                    ...
                                    <h2>{{$cancellationandrefunds->title}}</h2>

                                    <div class="separator"><span class="cir c-1"></span><span class="cir c-2"></span><span class="cir c-3"></span></div>

                                </div>

                                <div class="text">{!! $cancellationandrefunds->body !!}</div>
