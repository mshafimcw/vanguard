    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div style="text-align: center; margin-top: 25px;">
                <p><strong>Your contribution will help us:</strong></p>
                <ul style="text-align: left; display: inline-block;">
                    <li>Plant trees in deforested areas</li>
                    <li>Support environmental education programs</li>
                    <li>Fund sustainability research projects</li>
                    <li>Organize community clean-up drives</li>
                </ul>
            </div>
        ...
        <div class="footer">
            ...
            <p>Email: {{ env('MAIL_FROM_ADDRESS', 'contact@envedfoundation.org') }} | 
               Phone: {{ env('CONTACT_PHONE', '+91-9876543210') }}</p>
