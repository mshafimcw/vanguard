...
<body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
        ...
        <nav class="mt-2">
          ...
          <ul
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{ route('admin.page.create', ['slug' =>'second-logo']) }}" class="nav-link">
                    <i class="nav-icon bi bi-circle"></i>
                    <p>Create</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('admin.page.index', ['slug' => 'second-logo']) }}" class="nav-link">
                    <i class="nav-icon bi bi-circle"></i>
                    <p>List</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
			 ...
			 <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{ route('admin.page.create', ['slug' =>'about-us-home']) }}" class="nav-link">
                    <i class="nav-icon bi bi-circle"></i>
                    <p>Create</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('admin.page.index', ['slug' => 'about-us-home']) }}" class="nav-link">
                    <i class="nav-icon bi bi-circle"></i>
                    <p>List</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{ route('admin.page.create', ['slug' =>'companies']) }}" class="nav-link">
                    <i class="nav-icon bi bi-circle"></i>
                    <p>Create</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('admin.page.index', ['slug' => 'companies']) }}" class="nav-link">
                    <i class="nav-icon bi bi-circle"></i>
                    <p>List</p>
                  </a>
                </li>
			...
			<li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{ route('admin.page.create', ['slug' =>'common-banner']) }}" class="nav-link">
                    <i class="nav-icon bi bi-circle"></i>
                    <p>Create</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('admin.page.index', ['slug' => 'common-banner']) }}" class="nav-link">
                    <i class="nav-icon bi bi-circle"></i>
                    <p>List</p>
                  </a>
                </li>
 ...
 <li class="nav-header">Submissions</li>
         <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{ route('admin.contacts.index', ['slug' =>'social-icons']) }}" class="nav-link">
                    <i class="nav-icon bi bi-circle"></i>
                    <p>List</p>
                  </a>
                </li>
