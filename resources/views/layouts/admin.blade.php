...
/* Resize SVG arrow icons */
.pagination .page-link svg {
    width: 12px;
    height: 12px;
}

/* Optional: Center icon properly */
.pagination .page-link {
    display: flex;
    align-items: center;
    justify-content: center;
}
/* Force small arrow size */
nav svg {
        ...
        <nav class="mt-2">
          ...
          <ul
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{ route('admin.page.create', ['slug' =>'howitworksdescription']) }}" class="nav-link">
                    <i class="nav-icon bi bi-circle"></i>
                    <p>Create</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('admin.page.index', ['slug' => 'howitworksdescription']) }}" class="nav-link">
                    <i class="nav-icon bi bi-circle"></i>
                    <p>List</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{ route('admin.page.create', ['slug' =>'howitworks']) }}" class="nav-link">
                    <i class="nav-icon bi bi-circle"></i>
                    <p>Create</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('admin.page.index', ['slug' => 'howitworks']) }}" class="nav-link">
                    <i class="nav-icon bi bi-circle"></i>
                    <p>List</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{ route('admin.page.create', ['slug' =>'profiledescription']) }}" class="nav-link">
                    <i class="nav-icon bi bi-circle"></i>
                    <p>Create</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('admin.page.index', ['slug' => 'profiledescription']) }}" class="nav-link">
                    <i class="nav-icon bi bi-circle"></i>
                    <p>List</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{ route('admin.page.create', ['slug' =>'createaccountdescription']) }}" class="nav-link">
                    <i class="nav-icon bi bi-circle"></i>
                    <p>Create</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('admin.page.index', ['slug' => 'createaccountdescription']) }}" class="nav-link">
                    <i class="nav-icon bi bi-circle"></i>
                    <p>List</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{ route('admin.contact_messages.index') }}" class="nav-link">
                    <i class="nav-icon bi bi-circle"></i>
                    <p>List</p>
                  </a>
                </li>
