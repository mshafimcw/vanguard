    ...
    <header>
       ...
       <div class="header-area header-transparent">
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-1">
                                <div class="logo">
                                  <a href="/"><img src="{{$logo->title}}" alt=""></a>
                                </div>
                            </div>
          ...
          <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
            ...
            <li class="{{ request()->is('directorylisting') ? 'active' : '' }}"><a href="/directorylisting"><span>Directory Listing</span></a></li>
            <li class="{{ request()->is('events') ? 'active' : '' }}"><a href="/events"><span>Events</span></a></li>
